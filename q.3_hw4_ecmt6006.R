...
# Results -- (1.a)
VaRs = c(VaR_1_percent,VaR_5_percent, VaR_10_percent)   # print(VaRs)


## (1.b) -- 1% VaR using Historical Simulation (HS) and rolling window 250 days
...
df$VaR_HS <- c(rep(NA, 249), VaR_estimates)  # Prepend NA for the first 249
...
## (1.e) -- Evaluating VaR forecast w/ Hit_t+1 (conditional coverage tests)
# For (I) VaR_HS
